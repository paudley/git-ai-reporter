...
Beyond repairing existing tests, you are tasked with strategically expanding the test suite using advanced methodologies. The goal is to improve not just the quantity but the quality of test coverage, with the aspirational target of comprehensive core functionality coverage.
...
3. **Self-Correction Checklist:** You must perform a final review of your changes against every requirement detailed in this document. If any requirement has not been fully and correctly met, you must iterate on your solution until it is completely compliant.  
